...
// boton de Crear
function crear() {
    router.get(route("GrupoMaquina.Crear")); // Redirecciona a la Vista Crear
}
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <DataTable
                        ...
                        filterDisplay="row"
                        :loading="loading"
                        :globalFilterFields="['GrupoMaquina']"
                    >
                        <template #header>
                            <div
                        ...
                        <Column field="GrupoMaquina" header="GrupoMaquina"></Column>
