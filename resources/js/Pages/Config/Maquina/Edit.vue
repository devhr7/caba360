...
function submitUpdate() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Exitoso
            form.put(route("TipoCultivo.update", props.datos.slug), form);
            // Mensaje Final
            Swal.fire({
                title: "Alcualizado!",
...
function submitDelete() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Exitoso
            form.delete(route("TipoCultivo.delete", props.datos.slug), form);
            // Mensaje Final
            Swal.fire({
                title: "Eliminado!",
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    <div class="flex flex-col gap-2">
                                        <label for="TipoCultivo">TipoCultivo</label>
                                        <InputText
                                            id="TipoCultivo"
                                            name="TipoCultivo"
                                            v-model="form.TipoCultivo"
                                            aria-describedby="TipoCultivo-help"
                                        />
