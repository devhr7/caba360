...
const props = defineProps(["finca"]);
const reg_datatable = ref({});

// Filtros de busqueda
const filters = ref({
    global: { value: null, matchMode: FilterMatchMode.CONTAINS },
    finca: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
...
// boton de Crear
function crear() {
    router.get(route("Finca.Crear")); // Redirecciona a la Vista Crear
}
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <DataTable
                        ...
                        filterDisplay="row"
                        :loading="loading"
                        :globalFilterFields="['finca','distrito_id']"
                    >
                        <template #header>
                            <div
