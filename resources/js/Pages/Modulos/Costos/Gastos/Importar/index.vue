...
const validateFile = async () => {
    ...
    try {
        const response = await axios.post(
            route("costos.gastos.importar.validar"),
            formData,
            {
                headers: {
...
const submitForm = async () => {
    ...
    try {
        const response = await axios.post(
            route("costos.gastos.importar.subir"),
            formData,
            {
                headers: {
                    "Content-Type": "multipart/form-data",
                        ...
                        >
                            <thead>
                                <tr class="bg-gray-200 dark:bg-gray-700">
                                    ...
                                    <th class="border border-slate-300 px-4 py-2">Código</th>
                                    <th class="border border-slate-300 px-4 py-2">Nombre</th>
                                    <th class="border border-slate-300 px-4 py-2">Comprobante</th>
                                    <th class="border border-slate-300 px-4 py-2">Cantidad</th>
                                    <th class="border border-slate-300 px-4 py-2">Valor Unitario</th>
                                    <th class="border border-slate-300 px-4 py-2">Total</th>
                                    <th class="border border-slate-300 px-4 py-2">Observaciones</th>
                                    <th class="border border-slate-300 px-4 py-2">Finca</th>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Codigo }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Nombre }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Comprobante }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Cantidad }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.ValorUnitario }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Total }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Observaciones }}</td>
                                    <td class="border border-slate-300 px-4 py-2">{{ row.Finca }}</td>
